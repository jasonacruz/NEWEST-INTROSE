...
public class UIAdmin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        studentGenderComboBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
    ...
    private void IDNumFieldFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_IDNumFieldFocusLost
        if(!IDNumField.getText().equals("ID Number"))
        {
            if(eh.sCheckCodes(IDNumField.getText(),2))
